...
#                 val_output = vit_model(output)
    ...
    # 保存模型
    torch.save(m_csa_model.state_dict(), './saved_model/encode_model/m_csa/m_csa_model_parameters.pth')
    ...
    plot_confusion_matrix(conf_mat, ['Normal', 'Fault 1', 'Fault 2', 'Fault 3'], './result/m_csa_encode/confusion_matrix.png')
    # TODO 绘制训练数据tsne图
    features_for_tsne = []  
    labels_for_tsne = []  
    ...
    plt.savefig('./result/m_csa_encode/tsne_plot_test_features.png')  # 保存t-SNE图  
    plt.show()  
